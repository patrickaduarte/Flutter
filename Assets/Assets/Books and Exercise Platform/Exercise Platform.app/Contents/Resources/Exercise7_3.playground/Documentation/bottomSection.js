...
function submit() {
    ...
    req.open("POST", "http://127.0.0.1:" + eval_port + "/api/eval/" + chapterId + "/" + exerciseId, true);
    req.send();
}
...
function nextExercise() {
    ...
    req.open("POST", "http://127.0.0.1:" + eval_port + "/api/nextExercise/" + chapterId + "/" + exerciseId, true);
    req.send();
}
...
function getExerciseInfo() {
    ...
    req.open("POST", "http://127.0.0.1:" + eval_port + "/api/exerciseStatus/" + chapterId + "/" + exerciseId, true);
    req.send();
}
...
function openPDF() {
    ...
    req.open("POST", "http://127.0.0.1:" + eval_port + "/api/openPDF/" + chapterId, true);
    req.send();
}
...
window.onload = function() {
  ...
  eval_port = document.getElementById("eval_port").value;
  getExerciseInfo();
};
