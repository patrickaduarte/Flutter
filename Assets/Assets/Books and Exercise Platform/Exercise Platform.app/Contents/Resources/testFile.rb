...
class TestFile
    ...
    def initialize(filepath)
        ...
        testfile_data = open(filepath).read

        if testfile_data[/^id :x[0-9a-f]{32}/]
            testfile_data[/^id :x/] = "uid :x"
        ...
        unless testfile_data[/uid :x[0-9a-f]{32}/]
